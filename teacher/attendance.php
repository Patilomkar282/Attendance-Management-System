    ...
    <form action="" method="post">
      ...
      <div class="form-group">
        ...
        <label >Select Subject</label>
         ...
         <option  value="PA">Processor Architechture</option>
        <option  value="dbms">Database Management System</option>
        <option  value="M3">Mathmetics 3</option>
        <option  value="CG">Computer Graphics</option>
        <option  value="weblab">Processor Architechture Lab</option>
        <option  value="CGlab">Computer Graphics Lab</option>
